...
Version  : 24.02.1
Release  : 72
URL      : https://download.kde.org/stable/release-service/24.02.1/src/okular-24.02.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.1/src/okular-24.02.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.1/src/okular-24.02.1.tar.xz.sig
...
%prep
%setup -q -n okular-24.02.1
cd %{_builddir}/okular-24.02.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711032337
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libOkular6Core.so.1.0.0
...
/V3/usr/lib64/qt6/plugins/okular_generators/okularGenerator_plucker.so
...
/usr/lib64/libOkular6Core.so.1
/usr/lib64/libOkular6Core.so.1.0.0
...
/usr/lib64/qt6/plugins/okular_generators/okularGenerator_plucker.so
