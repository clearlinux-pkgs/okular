...
Source0  : https://download.kde.org/stable/release-service/20.12.1/src/okular-20.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.12.1/src/okular-20.12.1.tar.xz.sig
...
%prep
%setup -q -n okular-20.12.1
cd %{_builddir}/okular-20.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610058262
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/okular-20.12.1/COPYING %{buildroot}/usr/share/package-licenses/okular/a21ac62aee75f8fcb26b1de6fc90e5eea271854c
cp %{_builddir}/okular-20.12.1/COPYING.DOC %{buildroot}/usr/share/package-licenses/okular/0c4be15f5177aafffe980ca09c0f4ca6ed741f43
cp %{_builddir}/okular-20.12.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/okular/ba8966e2473a9969bdcab3dc82274c817cfd98a1
cp %{_builddir}/okular-20.12.1/cmake/modules/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/okular/ff3ed70db4739b3c6747c7f624fe2bad70802987
pushd clr-build
%make_install
popd
%find_lang okular
