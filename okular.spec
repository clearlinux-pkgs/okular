...
Source0  : https://download.kde.org/stable/release-service/24.08.0/src/okular-24.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.0/src/okular-24.08.0.tar.xz.sig
...
%setup -q -n okular-24.08.0
cd %{_builddir}/okular-24.08.0
pushd ..
cp -a okular-24.08.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724636356
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libOkular6Core.so.2.0.0
...
/usr/lib64/libOkular6Core.so.2
/usr/lib64/libOkular6Core.so.2.0.0
