...
Source0  : https://download.kde.org/stable/release-service/24.08.2/src/okular-24.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.2/src/okular-24.08.2.tar.xz.sig
...
%setup -q -n okular-24.08.2
cd %{_builddir}/okular-24.08.2
pushd ..
cp -a okular-24.08.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728840273
mkdir -p clr-build
pushd clr-build
