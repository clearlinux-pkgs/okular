...
%prep
%setup -q -n okular-20.08.2
cd %{_builddir}/okular-20.08.2
...
cp %{_builddir}/okular-20.08.2/COPYING.DOC %{buildroot}/usr/share/package-licenses/okular/0c4be15f5177aafffe980ca09c0f4ca6ed741f43
cp %{_builddir}/okular-20.08.2/COPYING.LIB %{buildroot}/usr/share/package-licenses/okular/ba8966e2473a9969bdcab3dc82274c817cfd98a1
cp %{_builddir}/okular-20.08.2/cmake/modules/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/okular/ff3ed70db4739b3c6747c7f624fe2bad70802987
pushd clr-build
%make_install
popd
%find_lang okular
